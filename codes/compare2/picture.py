...
if __name__ == '__main__':
 ...
 #   f4.set_title(r'$\tau=5$',fontsize=25,y=-0.2)
    ...
    plt.semilogy(x7_5,y7_5,label='[24]',color='c',linewidth=1.9,linestyle='dashdot')
    plt.semilogy(x6_5,y6_5,label='[38]',color='m',linewidth=1.9,linestyle='dashed')
    ...
    plt.semilogy(x4_5,y4_5,label='[44]',color='g',linewidth=1.9,linestyle=':')
    plt.semilogy(x3_5,y3_5,label='[41]',color='r',linewidth=1.9,linestyle='--')
